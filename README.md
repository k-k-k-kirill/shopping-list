...
Redux is used for maintaining global state of the shop list. React-redux hooks were used instead of "connect" function to avoid writing excessive boilerplate for containers. All global state is updated using immutable patterns. Products are injected to initial state using generateProducts utility.
